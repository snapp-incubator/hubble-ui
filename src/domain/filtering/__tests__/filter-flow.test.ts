...
describe('filterFlow', () => {
  ...
  testFilterEntry(
    () => `port > to port matches with destination port`,
  ...
  testFilterEntry(
    () => `port > to port doesn't match with source port`,
    FilterEntry.parse(`to:port=56789`)!,
    false,
    {
      diffNsFlow,
    },
  ...
  testFilterEntry(
    () => `port > from port matches with source port`,
  ...
  testFilterEntry(
    () => `port > from port doesn't match with destination port`,
    FilterEntry.parse(`from:port=80`)!,
    false,
    {
      diffNsFlow,
    },
  ...
  testFilterEntry(
    () => `port > either port matches with destination port`,
    FilterEntry.parse(`either:port=80`)!,
    true,
    {
      diffNsFlow,
    },
  ...
  testFilterEntry(
    () => `port > either port matches with source port`,
    FilterEntry.parse(`either:port=56789`)!,
    true,
    {
      diffNsFlow,
    },
  ...
  testFilterEntry(
    () => `port > either port doesn't match`,
    FilterEntry.parse(`either:port=9999`)!,
    false,
    {
      diffNsFlow,
    },
  ...
  testFilterEntry(
    () => `port > negative > either port matches`,
    FilterEntry.parse(`!either:port=9999`)!,
    true,
    {
      diffNsFlow,
  ...
  testFilterEntry(
    () => `port > negative > either port doesn't match`,
    FilterEntry.parse(`!either:port=80`)!,
    false,
    {
      diffNsFlow,
